...
web build:
 - http://mootools.net/core/998fa412da4c6b044d835e69867ab2cb

packager build:
 - packager build Core/Core Core/Event Core/Browser Core/Class Core/Element Core/Element.Style
...
}}this.$exec=p.exec;})();Object.extend({subset:function(c,f){var e={};for(var d=0,a=f.length;d<a;d++){var b=f[d];e[b]=c[b];}return e;},map:function(a,d,e){var c={};
